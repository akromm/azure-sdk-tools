...
namespace Microsoft.WindowsAzure.Management.SqlDatabase.Services.Server
{
    ...
    public partial class ServerDataServiceCertAuth : IServerDataServiceContext
    {
        ...
        public Database UpdateDatabase(string databaseName, string newDatabaseName, int? databaseMaxSize, DatabaseEdition? databaseEdition, ServiceObjective serviceObjective)
        {
            throw new NotImplementedException();
        }
