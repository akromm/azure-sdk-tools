...
Run-TestProtected {Run-Test {Test-NodeServiceCreation}".\emtest001.log"} "Emulator Node Hello World Scenario"
Run-TestProtected {Run-Test {Test-PHPServiceCreation} ".\emtest002.log"} "Emulator PHP Hello World Scenario"
Run-TestProtected {Run-Test {Test-NodeHelloInEmulator}} "Emulator Node Hello World Scenario"
