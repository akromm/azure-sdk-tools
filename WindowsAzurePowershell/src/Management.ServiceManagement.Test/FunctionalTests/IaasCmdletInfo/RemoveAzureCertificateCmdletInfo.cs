...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Test.FunctionalTests.IaasCmdletInfo
{
    ...
    public class RemoveAzureCertificateCmdletInfo : CmdletsInfo
    {
        public RemoveAzureCertificateCmdletInfo(string serviceName, string thumbprint, string algorithm)
        {
            cmdletName = Utilities.RemoveAzureCertificateCmdletName;
