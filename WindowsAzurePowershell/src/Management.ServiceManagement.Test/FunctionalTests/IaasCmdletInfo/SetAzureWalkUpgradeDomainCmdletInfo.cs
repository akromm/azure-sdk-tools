...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Test.FunctionalTests.IaasCmdletInfo
{
    ...
    public class SetAzureWalkUpgradeDomainCmdletInfo : CmdletsInfo
    {
        public SetAzureWalkUpgradeDomainCmdletInfo(string serviceName, string slot, int domainNumber)
        {
            ...
            cmdletParams.Add(new CmdletParam("DomainNumber", domainNumber));   
        }
    }
}
